...
const formsDatabase: FormOption[] = [
  // Legal Forms
  { id: 'basic-nda', code: 'NDA-01', name: 'Non-Disclosure Agreement', ministry: 'Ministry of the Attorney General', category: 'legal', pdfUrl: `${API_URL}/forms/Legal/Basic-Non-Disclosure-Agreement.pdf` },
  { id: 'contract-review', code: 'CTR-02', name: 'Standard Service Contract', ministry: 'Ministry of the Attorney General', category: 'legal', pdfUrl: `${API_URL}/forms/Legal/Basic-Non-Disclosure-Agreement.pdf` },
  { id: 'power-attorney', code: 'POA-03', name: 'Power of Attorney', ministry: 'Ministry of the Attorney General', category: 'legal', pdfUrl: `${API_URL}/forms/Legal/Basic-Non-Disclosure-Agreement.pdf` },

  // Finance Forms
  { id: 'cra-td1', code: 'TD1', name: 'Personal Tax Credits Return', ministry: 'Canada Revenue Agency', category: 'finance', pdfUrl: `${API_URL}/forms/Finance/td1-fill-26e.pdf` },
  { id: 'ontario-works', code: 'OW-APP', name: 'Ontario Works Application', ministry: 'Ministry of Children, Community and Social Services', category: 'finance', pdfUrl: `${API_URL}/forms/Finance/td1-fill-26e.pdf` },
  { id: 'gst-hst', code: 'GST34', name: 'GST/HST Return for Registrants', ministry: 'Canada Revenue Agency', category: 'finance', pdfUrl: `${API_URL}/forms/Finance/td1-fill-26e.pdf` },

  // Immigration Forms
  { id: 'oinp-application', code: 'OINP-01', name: 'Ontario Immigration Nominee Program', ministry: 'Immigration, Refugees and Citizenship Canada', category: 'immigration', pdfUrl: `${API_URL}/forms/Immigration/on00596e-immigration-nominee-program.pdf` },
];
